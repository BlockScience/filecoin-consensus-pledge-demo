...
The size of the required Consensus Pledge depends on the Target Locked Supply - a governance tunable parameter targetting a certain fraction (currently 30%) of the Circulating Supply to be locked up - and the relative size of newly onboarded QAP compared to Baseline Power or NetworkQAP, whichever is higher.  
